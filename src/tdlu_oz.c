/********************************************************************************/
/* tdlu_oz.c: Triple Precision LU decomposition with Ozaki scheme MM            */
/*                                                                              */
...
int TDLUdecomp_a22_oz(TDMatrix a, TDMatrix d22, TDMatrix l21, TDMatrix u12, long int start_index, long int min_dim, int max_num_div)
{
	...
	// d22 := l21 * u12
	mul_tdmatrix_oz(d22, l21, max_num_div, u12, max_num_div);
...
int TDLUdecomp_a22_oz_omp(TDMatrix a, TDMatrix d22, TDMatrix l21, TDMatrix u12, long int start_index, long int min_dim, int max_num_div)
{
	...
	// d22 := l21 * u12
	_bncomp_mul_tdmatrix_oz(d22, l21, max_num_div, u12, max_num_div);
...
/************************************************************/
{
	...
	for(i = 0; i < dim; i += min_dim)
	{
		...
		// (4) D22 := L21 * U12
		// (5) A22 := A22 - D22
		TDLUdecomp_a22_oz(a, d22, l21, u12, i, min_dim, max_num_div);
		//printf("D22:\n");
		//print_tdmatrix(d22);
		//print_tdmatrix(a);
...
/************************************************************/
{
	...
	for(i = 0; i < dim; i += min_dim)
	{
		...
		// (4) D22 := L21 * U12
		// (5) A22 := A22 - D22
		TDLUdecomp_a22_oz_omp(a, d22, l21, u12, i, min_dim, max_num_div);
