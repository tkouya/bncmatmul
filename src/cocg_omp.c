...
/* Main loop */
	for(times = 0; times < maxtimes; times++)
	{
		/* Ap */
#ifdef USE_SPARSE_VERSION
		_bncomp_mul_cdrsmatrix_cdvec(vec[3], a, vec[1]);
#else // USE_SPARSE_VERSION
		_bncomp_mul_cdmatrix_cdvec(vec[3], a, vec[1]);
#endif // USE_SPARSE_VERSION
...
/* Main loop */
	for(times = 0; times < maxtimes; times++)
	{
		/* Ap */
#ifdef USE_SPARSE_VERSION
		_bncomp_mul_cddrsmatrix_cddvec(vec[3], a, vec[1]);
#elif USE_SPARSE_D_VERSION
		_bncomp_mul_cdrsmatrix_cddvec(vec[3], a, vec[1]);
#else // USE_SPARSE_VERSION
		_bncomp_mul_cddmatrix_cddvec(vec[3], a, vec[1]);
#endif // USE_SPARSE_VERSION
		/* alpha = alpha_num / alpha_den */
...
/* Main loop */
	for(times = 0; times < maxtimes; times++)
	{
		/* Ap */
#ifdef USE_SPARSE_VERSION
		_bncomp_mul_ctdrsmatrix_ctdvec(vec[3], a, vec[1]);
#elif USE_SPARSE_D_VERSION
		_bncomp_mul_cdrsmatrix_ctdvec(vec[3], a, vec[1]);
#else // USE_SPARSE_VERSION
		_bncomp_mul_ctdmatrix_ctdvec(vec[3], a, vec[1]);
#endif // USE_SPARSE_VERSION
		/* alpha = alpha_num / alpha_den */
...
/* Main loop */
	for(times = 0; times < maxtimes; times++)
	{
		/* Ap */
#ifdef USE_SPARSE_VERSION
		_bncomp_mul_cqdrsmatrix_cqdvec(vec[3], a, vec[1]);
#elif USE_SPARSE_D_VERSION
		_bncomp_mul_cdrsmatrix_cqdvec(vec[3], a, vec[1]);
#else // USE_SPARSE_VERSION
		_bncomp_mul_cqdmatrix_cqdvec(vec[3], a, vec[1]);
#endif // USE_SPARSE_VERSION
		/* alpha = alpha_num / alpha_den */
...
/* Main loop */
	for(times = 0; times < maxtimes; times++)
	{
		/* Ap */
#ifdef USE_SPARSE_VERSION
		_bncomp_mul_cmpfrsmatrix_cmpfvec(vec[3], a, vec[1]);
#elif USE_SPARSE_D_VERSION
		_bncomp_mul_cdrsmatrix_cmpfvec(vec[3], a, vec[1]);
#else // USE_SPARSE_VERSION
		_bncomp_mul_cmpfmatrix_cmpfvec(vec[3], a, vec[1]);
#endif // USE_SPARSE_VERSION
		/* alpha = alpha_num / alpha_den */
