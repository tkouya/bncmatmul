/********************************************************************************/
/* matmul_strassen_general_dd_avx2.c:                                           */
...
//		for(j = 0; j < jmax; j++)
		for(j = 0; j < jmax; j += 4) // AVX2
		{
            ...
            // +1
			rdd_add(tmp_val, get_ddmatrix_ij(mat_a, a_i, a_j + 1), get_ddmatrix_ij(mat_b, b_i, b_j + 1));
			set_ddmatrix_ij(ret, ret_i, ret_j + 1, tmp_val);

            // +2
			rdd_add(tmp_val, get_ddmatrix_ij(mat_a, a_i, a_j + 2), get_ddmatrix_ij(mat_b, b_i, b_j + 2));
			set_ddmatrix_ij(ret, ret_i, ret_j + 2, tmp_val);

            // +3
			rdd_add(tmp_val, get_ddmatrix_ij(mat_a, a_i, a_j + 3), get_ddmatrix_ij(mat_b, b_i, b_j + 3));
			set_ddmatrix_ij(ret, ret_i, ret_j + 3, tmp_val);
...
//		for(j = 0; j < jmax; j++)
		for(j = 0; j < jmax; j += 4) // AVX2
		{
            ...
            // +1
            rdd_sub(tmp_val, get_ddmatrix_ij(mat_a, a_i, a_j + 1), get_ddmatrix_ij(mat_b, b_i, b_j + 1));
			set_ddmatrix_ij(ret, ret_i, ret_j + 1, tmp_val);

            // +2
            rdd_sub(tmp_val, get_ddmatrix_ij(mat_a, a_i, a_j + 2), get_ddmatrix_ij(mat_b, b_i, b_j + 2));
			set_ddmatrix_ij(ret, ret_i, ret_j + 2, tmp_val);

            // +1
            rdd_sub(tmp_val, get_ddmatrix_ij(mat_a, a_i, a_j + 3), get_ddmatrix_ij(mat_b, b_i, b_j + 3));
			set_ddmatrix_ij(ret, ret_i, ret_j + 3, tmp_val);
...
//		for(j = 0; j < jmax; j++)
		for(j = 0; j < jmax; j += 4) // AVX2
		{
			...
			set_ddmatrix_ij(ret, ret_i, ret_j + 1, get_ddmatrix_ij(mat_a, a_i, a_j + 1));
			set_ddmatrix_ij(ret, ret_i, ret_j + 2, get_ddmatrix_ij(mat_a, a_i, a_j + 2));
			set_ddmatrix_ij(ret, ret_i, ret_j + 3, get_ddmatrix_ij(mat_a, a_i, a_j + 3));
...
//		for(j = 0; j < jmax; j++)
		for(j = 0; j < jmax; j += 4) // AVX2
		{
			...
			rdd_neg(tmp, get_ddmatrix_ij(mat_a, a_i, a_j + 1));
			set_ddmatrix_ij(ret, ret_i, ret_j + 1, tmp);

			rdd_neg(tmp, get_ddmatrix_ij(mat_a, a_i, a_j + 2));
			set_ddmatrix_ij(ret, ret_i, ret_j + 2, tmp);

			rdd_neg(tmp, get_ddmatrix_ij(mat_a, a_i, a_j + 3));
			set_ddmatrix_ij(ret, ret_i, ret_j + 3, tmp);
#endif // __cplusplus
		}
	}
}
