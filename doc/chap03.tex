...
\begin{itemize}
    ...
    \funcitem{void}{mul\_mpfmatrix\_dvec\_oz}{\varname{MPFVector}{ret}, \varname{MPFMatrix}{a}, \varname{int}{max\_num\_div\_a}, \varname{MPFVector}{vb}, \varname{int}{max\_num\_div\_vb}}
