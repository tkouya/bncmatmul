...
\subsection{\bi{Double-double polynomial functions (\texttt{poly.c} --- \texttt{DDPoly}, \texttt{CDDPoly})}{double-double 多項式関数（\texttt{poly.c} --- \texttt{DDPoly}, \texttt{CDDPoly}）}}
...
\subsection{\bi{Triple-double polynomial functions (\texttt{poly.c} --- \texttt{TDPoly})}{triple-double 多項式関数（\texttt{poly.c} --- \texttt{TDPoly}）}}
...
\subsection{\bi{Quadruple-double polynomial functions (\texttt{poly.c} --- \texttt{QDPoly})}{quadruple-double 多項式関数（\texttt{poly.c} --- \texttt{QDPoly}）}}
...
\noindent \bi{Double-double Hirano (\texttt{dd\_hirano.c}):}{double-double 平野法（\texttt{dd\_hirano.c}）：}
