...
\subsection{\texttt{DDRSMatrix} \bi{and}{および} \texttt{CDDRSMatrix} --- \bi{double-double sparse matrices (requires \texttt{USE\_DDLINEAR})}{double-double疎行列（\texttt{USE\_DDLINEAR} が必要）}}
...
\subsection{\texttt{TDRSMatrix} \bi{and}{および} \texttt{CTDRSMatrix} --- \bi{triple-double sparse matrices (requires \texttt{USE\_TDLINEAR})}{triple-double疎行列（\texttt{USE\_TDLINEAR} が必要）}}
...
\subsection{\texttt{QDRSMatrix} \bi{and}{および} \texttt{CQDRSMatrix} --- \bi{quadruple-double sparse matrices (requires \texttt{USE\_QDLINEAR})}{quadruple-double疎行列（\texttt{USE\_QDLINEAR} が必要）}}
...
\begin{itemize}
    ...
    \funcitem{DDRSMatrix}{init\_set\_ddrsmatrix\_mpfrsmatrix}{\varname{MPFRSMatrix}{org}}\ \bi{(requires \texttt{USE\_DDLINEAR})}{（\texttt{USE\_DDLINEAR} が必要）}
    \funcitem{CDDRSMatrix}{init\_set\_cddrsmatrix\_cmpfrsmatrix}{\varname{CMPFRSMatrix}{org}}\ \bi{(requires \texttt{USE\_DDLINEAR})}{（\texttt{USE\_DDLINEAR} が必要）}
    \funcitem{TDRSMatrix}{init\_set\_tdrsmatrix\_mpfrsmatrix}{\varname{MPFRSMatrix}{org}}\ \bi{(requires \texttt{USE\_TDLINEAR})}{（\texttt{USE\_TDLINEAR} が必要）}
    \funcitem{CTDRSMatrix}{init\_set\_ctdrsmatrix\_cmpfrsmatrix}{\varname{CMPFRSMatrix}{org}}\ \bi{(requires \texttt{USE\_TDLINEAR})}{（\texttt{USE\_TDLINEAR} が必要）}
    \funcitem{QDRSMatrix}{init\_set\_qdrsmatrix\_mpfrsmatrix}{\varname{MPFRSMatrix}{org}}\ \bi{(requires \texttt{USE\_QDLINEAR})}{（\texttt{USE\_QDLINEAR} が必要）}
    \funcitem{CQDRSMatrix}{init\_set\_cqdrsmatrix\_cmpfrsmatrix}{\varname{CMPFRSMatrix}{org}}\ \bi{(requires \texttt{USE\_QDLINEAR})}{（\texttt{USE\_QDLINEAR} が必要）}
\end{itemize}
...
\noindent \bi{Double-double CG (requires \texttt{USE\_DDLINEAR}):}{double-double CG（\texttt{USE\_DDLINEAR} が必要）：}
...
\noindent \bi{Triple-double CG (requires \texttt{USE\_TDLINEAR}):}{triple-double CG（\texttt{USE\_TDLINEAR} が必要）：}
...
\noindent \bi{Quadruple-double CG (requires \texttt{USE\_QDLINEAR}):}{quadruple-double CG（\texttt{USE\_QDLINEAR} が必要）：}
...
\subsection{\bi{BiCG, CGS, BiCGSTAB, GPBiCG methods (double-double; requires \texttt{USE\_DDLINEAR})}{BiCG, CGS, BiCGSTAB, GPBiCG 法（double-double。\texttt{USE\_DDLINEAR} が必要）}}
...
\subsection{\bi{BiCG, CGS, BiCGSTAB, GPBiCG methods (triple-double; requires \texttt{USE\_TDLINEAR})}{BiCG, CGS, BiCGSTAB, GPBiCG 法（triple-double。\texttt{USE\_TDLINEAR} が必要）}}
...
\subsection{\bi{BiCG, CGS, BiCGSTAB, GPBiCG methods (quadruple-double; requires \texttt{USE\_QDLINEAR})}{BiCG, CGS, BiCGSTAB, GPBiCG 法（quadruple-double。\texttt{USE\_QDLINEAR} が必要）}}
